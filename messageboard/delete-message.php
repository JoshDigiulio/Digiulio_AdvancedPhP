...
if(isset($_POST['btn-del']))
{
    ...
    $id = $_GET['delete_id'];
    //$pcrud is a PHP object created somewhere, and delte is a function defined in that object that is being called with the variable $id being passed to it:
    $pcrud->delete($id);
            ...
            <table class='table table-bordered'>
                ...
                while($row=$stmt->fetch(PDO::FETCH_BOTH))
                {
                    ...
                    <tr>
                        ...
                        <!-- Fills/populates the message row: -->
                        <td><?php print($row['message']); ?></td>
                        <!-- Fills/populates the created row: -->
    ...
    <div class="container">
        ...
        <form method="post">
            ...
            <input type="hidden" name="id" value="<?php echo $row['id']; ?>" />
             <!-- A delete button with the Bootstrap styling and a glyphicon trash symbol:  -->   
